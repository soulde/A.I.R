...
void MainWindow::updateTable() {
    ...
    table.getTable("select names.ID as '学号', Name as '姓名', [score record].Score as '分数', School as '学院', Grade as '年级', TechGroup as '技术组组别', AdminGroup as '管理部组别', QQ as 'QQ号码', Tel as '手机号码' from [names] join [score record] on names.ID = [score record].ID group by names.ID", db);
    char **pT;
    int rows, cols;
